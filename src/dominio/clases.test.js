...
test('creación de un gasto', () => {
  let unGasto = new Gasto("20/02/2020", "Vestimenta", 2500, "Compra vestido casamiento Ana", "Efectivo", 1, "No");
...
test('creación de un ingreso', () => {
  let unIngreso = new Ingreso("28/02/2020", "Sueldo", 10500, "Sueldo febrero", "Efectivo");
...
test('creación de un Recordatorio', () => {
  let unRecordatorio = new Recordatorio("28/02/2020", "Llamar Juan");
